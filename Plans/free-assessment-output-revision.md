...
shipped-commits:
  - 006ebd1  # T1 CTA rank (Foundation $295 primary tiers 1–3)
  ...
  - 40448c9  # PDF gen macOS platform gate
  - e46ec11  # PDF Chrome isolation (no tabs in user browser)
human-followup: see Ship gate "🔒 HUMAN" section in tasks file (H1–H4)
---
