...
| [ADDIE Foundation rebuild (`feature/addie-v1`)](../docs/Foundation-Course-ADDIE/AiBI_Start_Here.md) | (tracker is `docs/Foundation-Course-ADDIE/AiBI_Module_Production_Tracker.md` + `AiBI_Launch_Checklist.md`) | **Wave 1 done, Wave 2 next** | Shared dependencies (DB, sandbox, auth/payments) shipped 2026-05-23; 19 commits ahead of main; all isolated to `addie.*` schema + `(addie)` route group; `public.*` untouched. Wave 2 = web app shell + M0–M3 module scaffolding (see Start_Here §7). Audit: `AiBI_Wave_1_Audit_2026-05-23.md`. | — (branch-scoped, not on GitHub issue board) |
