...
| [Content engine (Scout + queue + admin UI)](../Plans/content-engine.md) | [`content-engine.md`](./content-engine.md) | **~70** | Plan + initial scaffold on `feature/content-engine` — code in [`/content-engine/`](../content-engine/) | _no GH issue yet_ |
