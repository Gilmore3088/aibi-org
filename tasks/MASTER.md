...
| [Performance optimization (May 2026)](../Plans/performance-optimization-2026-05-17.md) | [`performance-optimization-2026-05-17.md`](./performance-optimization-2026-05-17.md) | **~20** | Active | **Session 2026-05-17 total: -84 KB First Load JS on `/assessment` (190→106), -64 KB on every marketing route, -8 KB CSS on every page, -2.4 MB deploy.** Shipped: Wave A (`13e7f65`), Wave A+ Supabase out (`3f92c4f`), SVGO hero (`fe3bd48`), lazy ResultsViewV2 (`4f61dad`), fonts off public + weights trimmed (`09100a6`), bundle-analyzer (`34b0bba`). Open: AP9–AP14 post-ship validation, Wave B (Early Hints), Wave C (Cormorant SC decision), Wave D (Lighthouse re-measure), Wave E (E.1 font-override deeper fix, E.3 dashboard 80 KB gz refactor, E.4 program tree-shake, E.7 static /, E.8 Tailwind audit). Audit trail at [`docs/reviews/performance-overhaul-2026-05-17.md`](../docs/reviews/performance-overhaul-2026-05-17.md) |
