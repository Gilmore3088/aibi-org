...
export function sendCoursePurchaseIndividual(
  ...
  const courseName = payload.courseName ?? 'AiBI Foundations';
  return sendTemplate({
    to: payload.email,
    ...
    variables: {
      ...
      COURSE_URL:
        ...
        payload.courseUrl ??
        'https://aibankinginstitute.com/courses/foundations',
...
export function sendCoursePurchaseInstitution(
  ...
  return sendTemplate({
    ...
    subject: `${payload.institutionName} — your AiBI Foundations seats are ready`,
    variables: {
      ...
      COURSE_URL: 'https://aibankinginstitute.com/courses/foundations',
    },
  });
}
...
export function sendCertificateIssued(
  ...
  return sendTemplate({
    ...
    subject: `Your Foundations Certificate is ready, ${payload.holderName}`,
    variables: {
