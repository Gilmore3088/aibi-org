// TransformationReportDocument — React PDF component for the AiBI-Practitioner Transformation Report.
  ...
  return (
    <Page size="LETTER" style={styles.page}>
      ...
      <View style={styles.coverBody}>
        <View>
          <Text style={styles.coverEyebrow}>AiBI-Practitioner</Text>
  ...
  return (
    <Page size="LETTER" style={styles.pageParch}>
      <View style={styles.pageHeader}>
        <Text style={styles.pageHeaderEyebrow}>AiBI-Practitioner Transformation Report  ·  Page 2</Text>
...
function SkillsPage({ skills }: Pick<TransformationReportProps, 'skills'>) {
  return (
    <Page size="LETTER" style={styles.pageParch}>
      <View style={styles.pageHeader}>
        <Text style={styles.pageHeaderEyebrow}>AiBI-Practitioner Transformation Report  ·  Page 3</Text>
...
function ImpactPage({
  ...
  return (
    <Page size="LETTER" style={styles.pageParch}>
      <View style={styles.pageHeader}>
        <Text style={styles.pageHeaderEyebrow}>AiBI-Practitioner Transformation Report  ·  Page 4</Text>
...
>) {
  ...
  return (
    <Page size="LETTER" style={styles.pageParch}>
      <View style={styles.pageHeader}>
        <Text style={styles.pageHeaderEyebrow}>AiBI-Practitioner Transformation Report  ·  Page 5</Text>
      ...
      <View style={styles.pageBody}>
        ...
        <View style={styles.credentialBox}>
          <View>
            ...
            <Text style={styles.credentialValue}>AiBI-Practitioner</Text>
        ...
        <Text style={styles.noteText}>
          ...
          credential display format for sharing is: AiBI-Practitioner · The AI Banking Institute.
...
export function TransformationReportDocument(props: TransformationReportProps) {
  return (
    <Document
      title={`AiBI-Practitioner Transformation Report — ${props.learnerName} — The AI Banking Institute`}
      author="The AI Banking Institute"
      subject="AiBI-Practitioner Banking AI Practitioner Transformation Report"
    >
      <CoverPage
