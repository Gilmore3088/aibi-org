// TransformationReportDocument — React PDF component for the AiBI-Foundation Transformation Report.
  ...
  return (
    <Page size="LETTER" style={styles.page}>
      ...
      <View style={styles.coverBody}>
        <View>
          <Text style={styles.coverEyebrow}>AiBI-Foundation</Text>
  ...
  return (
    <Page size="LETTER" style={styles.pageParch}>
      <View style={styles.pageHeader}>
        <Text style={styles.pageHeaderEyebrow}>AiBI-Foundation Transformation Report  ·  Page 2</Text>
...
function SkillsPage({ skills }: Pick<TransformationReportProps, 'skills'>) {
  return (
    <Page size="LETTER" style={styles.pageParch}>
      <View style={styles.pageHeader}>
        <Text style={styles.pageHeaderEyebrow}>AiBI-Foundation Transformation Report  ·  Page 3</Text>
...
function ImpactPage({
  ...
  return (
    <Page size="LETTER" style={styles.pageParch}>
      <View style={styles.pageHeader}>
        <Text style={styles.pageHeaderEyebrow}>AiBI-Foundation Transformation Report  ·  Page 4</Text>
...
>) {
  ...
  return (
    <Page size="LETTER" style={styles.pageParch}>
      <View style={styles.pageHeader}>
        <Text style={styles.pageHeaderEyebrow}>AiBI-Foundation Transformation Report  ·  Page 5</Text>
      ...
      <View style={styles.pageBody}>
        ...
        <Text style={styles.noteText}>
          ...
          credential display format for sharing is: AiBI-Foundation · The AI Banking Institute.
