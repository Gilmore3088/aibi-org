// TransformationReportDocument — React PDF component for the AiBI Foundations Transformation Report.
  ...
  return (
    <Page size="LETTER" style={styles.page}>
      ...
      <View style={styles.coverBody}>
        <View>
          <Text style={styles.coverEyebrow}>AiBI Foundations</Text>
  ...
  return (
    <Page size="LETTER" style={styles.pageParch}>
      <View style={styles.pageHeader}>
        <Text style={styles.pageHeaderEyebrow}>AiBI Foundations Transformation Report  ·  Page 2</Text>
...
function SkillsPage({ skills }: Pick<TransformationReportProps, 'skills'>) {
  return (
    <Page size="LETTER" style={styles.pageParch}>
      <View style={styles.pageHeader}>
        <Text style={styles.pageHeaderEyebrow}>AiBI Foundations Transformation Report  ·  Page 3</Text>
...
function ImpactPage({
  ...
  return (
    <Page size="LETTER" style={styles.pageParch}>
      <View style={styles.pageHeader}>
        <Text style={styles.pageHeaderEyebrow}>AiBI Foundations Transformation Report  ·  Page 4</Text>
...
>) {
  ...
  return (
    <Page size="LETTER" style={styles.pageParch}>
      <View style={styles.pageHeader}>
        <Text style={styles.pageHeaderEyebrow}>AiBI Foundations Transformation Report  ·  Page 5</Text>
      ...
      <View style={styles.pageBody}>
        ...
        <View style={styles.credentialBox}>
          <View>
            ...
            <Text style={styles.credentialValue}>AiBI Foundations</Text>
            <Text style={styles.credentialSub}>Banking AI Foundations  ·  The AI Banking Institute</Text>
          </View>
          <View>
        ...
        <Text style={styles.noteText}>
          ...
          credential display format for sharing is: AiBI Foundations · The AI Banking Institute.
...
export function TransformationReportDocument(props: TransformationReportProps) {
  return (
    <Document
      title={`AiBI Foundations Transformation Report — ${props.learnerName} — The AI Banking Institute`}
      author="The AI Banking Institute"
      subject="AiBI Foundations Banking AI Foundations Transformation Report"
    >
      <CoverPage
