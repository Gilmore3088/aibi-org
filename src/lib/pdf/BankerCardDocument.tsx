...
const styles = StyleSheet.create({
  page: { backgroundColor: WHITE, fontFamily: 'Helvetica', fontSize: '0.625rem', color: INK, paddingBottom: 56 },
  header: { backgroundColor: INK, paddingVertical: 26, paddingHorizontal: 40 },
  seal: { fontSize: '0.5rem', color: GOLD, letterSpacing: 2, marginBottom: 10, fontFamily: 'Helvetica-Bold' },
  title: { fontFamily: 'Helvetica-Bold', fontSize: '1.3125rem', color: WHITE, marginBottom: 6 },
  subtitle: { fontSize: '0.625rem', color: CREAM, opacity: 0.9 },
  body: { paddingHorizontal: 40, paddingTop: 22 },
  blockHeading: { fontFamily: 'Helvetica-Bold', fontSize: '0.6875rem', color: GOLD_DEEP, textTransform: 'uppercase', letterSpacing: 1, marginTop: 14, marginBottom: 8 },
  row: { flexDirection: 'row', marginBottom: 7 },
  rowTerm: { width: 110, fontFamily: 'Helvetica-Bold', fontSize: '0.625rem', color: INK },
  rowDetail: { flex: 1, fontSize: '0.625rem', color: INK, lineHeight: 1.45 },
  move: { flexDirection: 'row', marginBottom: 7, alignItems: 'flex-start' },
  moveNum: { width: 22, fontFamily: 'Helvetica-Bold', fontSize: '0.75rem', color: GOLD },
  moveLabel: { width: 92, fontFamily: 'Helvetica-Bold', fontSize: '0.6875rem', color: INK },
  moveNote: { flex: 1, fontSize: '0.625rem', color: SLATE, lineHeight: 1.45 },
  zoneRow: { flexDirection: 'row', marginBottom: 8, borderLeftWidth: 4, paddingLeft: 10 },
  zoneName: { width: 60, fontFamily: 'Helvetica-Bold', fontSize: '0.6875rem' },
  zoneCol: { flex: 1, paddingRight: 8 },
  zoneLabel: { fontSize: '0.4688rem', color: SLATE, textTransform: 'uppercase', letterSpacing: 0.6, marginBottom: 2 },
  zoneText: { fontSize: '0.5938rem', color: INK, lineHeight: 1.4 },
  ...
  footerText: { fontSize: '0.4688rem', color: SLATE },
});
