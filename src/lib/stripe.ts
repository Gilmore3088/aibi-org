...
// Uses Stripe SDK v22. API version: 2026-05-27.dahlia.

import Stripe from 'stripe';
import { assertProductionStripeKey } from '@/lib/stripe/assert-live-key';
...
// Fail fast if a test-mode key is configured in Vercel production — a
// test key there silently routes real customers through Stripe test mode.
...
export interface CheckoutMetadata {
  ...
  product: 'aibi-p' | 'foundation' | 'in-depth-assessment' | 'team-assessment';
