...
const JOURNEY_STEPS: Record<string, JourneyStep> = {
  'aibi-p': {
    ...
    body: 'The AiBI-S Specialist course is a 6-week live cohort for department managers. Deploy governed AI automation to your team with peer accountability and instructor guidance.',
    href: '/courses/aibi-s',
    cta: 'Explore AiBI-S',
  ...
  'aibi-s': {
    ...
    body: 'The AiBI-L Leader workshop is a 1-day in-person session for C-suite and board. Leave with a board-ready AI presentation built with your numbers.',
    href: '/courses/aibi-l',
    cta: 'Explore AiBI-L',
  ...
  'aibi-l': {
    ...
    body: 'AiBI-P, AiBI-S, and AiBI-L earned. View your complete certification journey and cumulative impact metrics on your dashboard.',
