  ...
  return (
    <div className="md:hidden">
      ...
      <button
        ...
        className="p-2 -mr-2 text-[color:var(--color-ink)] hover:text-[color:var(--color-terra)] transition-colors focus:outline-none focus:ring-2 focus:ring-[color:var(--color-terra)] focus:ring-offset-2 rounded-[2px]"
      >
        {open ? (
          // X icon
      ...
      {open && (
        <>
          ...
          <nav
            ...
            className="fixed top-0 right-0 z-50 h-full w-72 bg-[color:var(--color-linen)] border-l border-[color:var(--color-ink)]/10 shadow-lg overflow-y-auto"
          >
            {/* Close button */}
            <div className="flex justify-end p-5">
              <button
                ...
                className="p-2 text-[color:var(--color-ink)] hover:text-[color:var(--color-terra)] transition-colors focus:outline-none focus:ring-2 focus:ring-[color:var(--color-terra)] rounded-[2px]"
              >
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden="true">
                  <path d="M5 5l10 10M15 5L5 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                </svg>
