...
export function ROICalculator() {
  return (
    <section
      id="roi-calculator"
      className="px-6 py-14 md:py-20 bg-[color:#FFFFFF] border-y border-[color:var(--ink)]/10"
    >
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className="font-serif text-4xl md:text-5xl text-[color:var(--ink)] max-w-3xl mx-auto leading-tight">
            Run your own numbers.
          </h2>
          <p className="text-lg text-[color:var(--ink)]/70 max-w-2xl mx-auto mt-5 leading-relaxed">
        ...
        <div className="grid md:grid-cols-5 gap-8 md:gap-12">
          <div className="md:col-span-2 space-y-6">
            <div className="border border-[color:var(--ink)]/10 bg-[color:var(--cream)] p-6">
              <p className="font-serif-sc text-[11px] uppercase tracking-[0.2em] text-[color:var(--ink)]/70 mb-3">
                What this models
              </p>
              <ul className="space-y-3 text-sm text-[color:var(--ink)]/75 leading-relaxed">
                <li>Staff count</li>
