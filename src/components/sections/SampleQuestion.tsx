...
export function SampleQuestion() {
  ...
  return (
    <section className="px-6 py-14 md:py-20 bg-[color:#FFFFFF]">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-10">
          <p className="font-serif-sc text-xs uppercase tracking-[0.2em] text-[color:var(--ink)]/70 mb-4">
            Interactive preview
          </p>
          <h2 className="font-serif text-3xl md:text-4xl text-[color:var(--ink)] leading-tight">
            Experience a sample question.
          </h2>
          <p className="text-[color:var(--ink)]/75 mt-4 max-w-xl mx-auto leading-relaxed">
        ...
        <div className="bg-[color:var(--cream)] border border-[color:var(--ink)]/10 rounded-[3px] p-8 md:p-10">
          <p className="font-serif-sc text-[11px] uppercase tracking-[0.2em] text-[color:var(--gold)] mb-3">
            {SAMPLE.dimension}
          </p>
          <h3 className="font-serif text-2xl md:text-3xl text-[color:var(--ink)] leading-tight mb-8">
            {SAMPLE.prompt}
          </h3>
                ...
                <button
                  ...
                  className={
                    ...
                    (isSelected
                      ...
                      : 'border-[color:var(--ink)]/15 hover:border-[color:var(--gold)] hover:bg-[color:var(--cream-2)]/10')
                  }
                >
                  <span
                    className={
                      ...
                      (isSelected
                        ...
                        : 'border-[color:var(--ink)]/30 text-[color:var(--ink)]/70')
                    }
                  >
                    {String.fromCharCode(65 + idx)}
                  </span>
                  <span className="font-sans text-base text-[color:var(--ink)] leading-snug pt-1">
                    {option.label}
                  </span>
                </button>
              );
          ...
          {selected !== null && (
            <div className="mt-8 pt-6 border-t border-[color:var(--ink)]/10 text-center">
              <p className="text-[color:var(--ink)]/75 mb-4 leading-relaxed">
