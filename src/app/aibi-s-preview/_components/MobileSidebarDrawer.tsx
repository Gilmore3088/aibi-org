...
const PROTOTYPE_PHASES = [
  { label: 'Phase I — Foundation', colorVar: 'var(--color-cobalt)' },
  { label: 'Phase II — First Build', colorVar: 'var(--color-cobalt)' },
  { label: 'Phase III — Scale', colorVar: 'var(--color-cobalt)' },
];
