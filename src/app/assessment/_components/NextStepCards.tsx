    ...
    <section data-print-hide="true">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {steps.map((step) => (
          <article
            key={step.title}
            className="bg-[color:var(--color-parch)] border border-[color:var(--color-ink)]/10 rounded-[3px] p-6 md:p-8 flex flex-col hover:border-[color:var(--color-terra)]/30 transition-colors duration-200"
          >
            <p
