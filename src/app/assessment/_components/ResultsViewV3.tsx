...
import {
  ...
  RoiContextPanel,
  TakeawayNum,
} from './results-view-v3/SupportingPanels';
import { getStarterArtifact } from '@content/assessments/v3/starter-artifacts';
import type { RoiAssessmentContext } from '@/lib/roi/assessment-context';
import {
  GAP_CONTENT,
  RECOMMENDATIONS,
  STARTER_PROMPTS,
...
export function ResultsViewV3({
  ...
  return (
    <>
      ...
      {/* HERO */}
      <section
        data-testid="readiness-result-hero"
        data-focus-gap={focusGap?.id}
      ...
      {focusGap && (
        <section>
          ...
          <div className="mt-7 grid md:grid-cols-3 gap-5">
            ...
            {artifact && (
              <article
                data-testid="working-artifact"
                data-artifact-dimension={focusGap.id}
