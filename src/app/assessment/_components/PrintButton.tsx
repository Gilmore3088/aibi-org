...
export function PrintButton() {
  ...
  return (
    <button
      ...
      className="font-serif-sc text-xs uppercase tracking-[0.2em] text-[color:var(--color-ink)]/70 hover:text-[color:var(--gold)] transition-colors border-b border-[color:var(--color-ink)]/30 hover:border-[color:var(--gold)] pb-1"
