...
export const starterKits: StarterKit[] = [
  {
    ...
    items: [
      ...
      { label: 'AI Workflow SOP Template', href: '/artifacts/ai-workflow-sop-template.md' },
    ],
    icon: ShieldCheck,
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Prompt Strategy Cheat Sheet', href: '/downloads/prompt-strategy-cheat-sheet.pdf' },
      { label: 'AI Workflow SOP Template', href: '/artifacts/ai-workflow-sop-template.md' },
      { label: 'AI Policy Starter', href: '/artifacts/ai-policy-starter.md' },
    ],
    icon: Megaphone,
  },
  {
...
export const problemPaths: ProblemPath[] = [
  { title: 'Set AI rules', artifact: 'AI Policy Starter', href: '/artifacts/ai-policy-starter.md', icon: ShieldCheck },
  ...
  { title: 'Build a workflow SOP', artifact: 'AI Workflow SOP Template', href: '/artifacts/ai-workflow-sop-template.md', icon: Workflow },
  { title: 'Brief leadership', artifact: 'Board Briefing Checklist', href: '/artifacts/board-briefing-checklist.md', icon: BarChart3 },
...
export const templates: Template[] = [
  ...
  },
  {
    ...
    href: '/artifacts/ai-workflow-sop-template.md',
    icon: Workflow,
  },
  {
    ...
    href: '/artifacts/board-briefing-checklist.md',
    icon: BarChart3,
  },
  {
    title: 'AI Policy Starter',
    format: 'Markdown · 8 min',
    ...
    href: '/artifacts/ai-policy-starter.md',
    icon: FileText,
  },
];
...
export function allDownloadHrefs(): string[] {
  ...
  templates.forEach((t) => hrefs.add(t.href));
