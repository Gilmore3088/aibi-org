...
export const metadata: Metadata = {
  ...
  description:
    'Interactive working template for documenting one AI-assisted workflow end to end: tool, allowed inputs, output, reviewer, approval checkpoint, escalation path, and retention rule.',
