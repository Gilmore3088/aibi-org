...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'The AI Banking Institute — Coming Soon',
    description:
      'AI proficiency for community banks and credit unions. Readiness assessment, practitioner education, enterprise rollout, and advisory.',
    type: 'website',
...
export default async function ComingSoonPage({ searchParams }: ComingSoonPageProps) {
  ...
  return (
    <main className="min-h-screen bg-[color:var(--color-linen)] text-[color:var(--color-ink)] flex flex-col">
      ...
      <section className="flex-1 mx-auto w-full max-w-5xl px-6 md:px-10 py-10 md:py-16">
        <h1 className="font-serif text-[36px] leading-[1.08] md:text-[48px] md:leading-[1.05] tracking-[-0.01em] max-w-3xl">
          AI proficiency for community banks and credit unions.
        </h1>

        <p className="mt-5 max-w-2xl text-[16px] md:text-[17px] leading-[1.6] text-[color:var(--color-ink)]/80">
        ...
        <div className="mt-10 grid gap-10 md:gap-16 md:grid-cols-12">
          <div className="order-1 md:order-2 md:col-span-6 md:pl-4">
            <WaitlistForm initialInterest={interest} />
          </div>

          <div className="order-2 md:order-1 md:col-span-6 md:pr-4">
