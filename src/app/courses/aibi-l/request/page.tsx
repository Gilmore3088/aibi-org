  ...
  if (status === 'success') {
    return (
      <div className="max-w-xl mx-auto px-4 sm:px-8 py-20 text-center">
        ...
        <Link
          href="/courses/aibi-l"
          className="inline-flex items-center gap-2 font-mono text-[9px] uppercase tracking-[0.15em] text-[color:var(--ink-2)] hover:opacity-70 transition-opacity"
        >
    ...
    <div className="max-w-xl mx-auto px-4 sm:px-8 py-20">
      ...
      <nav className="mb-10" aria-label="Breadcrumb">
        <div className="flex items-center gap-2 font-mono text-[9px] uppercase tracking-[0.2em]">
          <Link
            href="/courses/aibi-l"
            className="text-[color:var(--ink-2)] hover:opacity-70 transition-opacity"
          >
            AiBI-L
          </Link>
      ...
      <header className="mb-12">
        <h1 className="font-serif text-4xl sm:text-5xl font-bold text-[color:var(--color-ink)] mb-4 leading-tight">
          Request a <span className="italic text-[color:var(--ink-2)]">Workshop</span>
        </h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <input
            ...
            className="w-full bg-[color:var(--color-parch)] border border-[color:var(--ink-2)]/15 rounded-sm px-4 py-3 font-sans text-sm text-[color:var(--color-ink)] placeholder:text-[color:var(--color-dust)] focus:outline-none focus:ring-2 focus:ring-[color:var(--ink-2)] focus:border-transparent"
        ...
        <div>
          ...
          <select
            ...
            value={form.teamSize}
            onChange={handleChange}
            className="w-full bg-[color:var(--color-parch)] border border-[color:var(--ink-2)]/15 rounded-sm px-4 py-3 font-sans text-sm text-[color:var(--color-ink)] focus:outline-none focus:ring-2 focus:ring-[color:var(--ink-2)] focus:border-transparent"
          >
        ...
        <div>
          ...
          <textarea
            ...
            value={form.message}
            onChange={handleChange}
            className="w-full bg-[color:var(--color-parch)] border border-[color:var(--ink-2)]/15 rounded-sm px-4 py-3 font-sans text-sm text-[color:var(--color-ink)] placeholder:text-[color:var(--color-dust)] focus:outline-none focus:ring-2 focus:ring-[color:var(--ink-2)] focus:border-transparent resize-none"
        ...
        <button
          ...
          className="w-full bg-[color:var(--ink-2)] hover:opacity-90 text-[color:var(--color-linen)] px-8 py-4 rounded-sm font-bold text-[10px] uppercase tracking-[0.15em] transition-opacity font-mono focus:outline-none focus:ring-2 focus:ring-[color:var(--ink-2)] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
        >
