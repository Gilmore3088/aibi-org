  ...
  return (
    <div className={depth === 0 ? 'mb-10' : 'mb-6'}>
      <div className="flex items-center gap-3 mb-2">
        <span className="font-mono text-[10px] tabular-nums text-[color:var(--ink-2)]">
          {section.id}
        </span>
        <div className="h-px flex-1 max-w-[2rem] bg-[color:var(--ink-2)]/15" aria-hidden="true" />
      </div>
      ...
      {section.subsections?.map((sub) => (
        <div key={sub.id} className="mt-4 ml-4 pl-4 border-l border-[color:var(--ink-2)]/10">
      ...
      <CourseTabs
        ...
        learnContent={
          <>
            ...
            {workshopSession.statistics && workshopSession.statistics.length > 0 && (
              <section
                className="mb-16 border-t border-[color:var(--ink-2)]/10 pt-8"
        ...
        applyContent={
          <>
            ...
            <section
              className="bg-[color:var(--color-parch)] border border-[color:var(--ink-2)]/15 rounded-sm p-8 sm:p-10 mb-16"
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <div className="h-px flex-1 bg-[color:var(--ink-2)]/15" aria-hidden="true" />
              ...
              <div className="border-t border-[color:var(--ink-2)]/10 pt-4">
                <p className="font-mono text-[9px] uppercase tracking-[0.15em] text-[color:var(--ink-2)] mb-1">
                  Deliverable
                </p>
            ...
            {/* Navigation */}
            <nav className="flex items-center justify-between pt-8 border-t border-[color:var(--ink-2)]/10">
              {prevSession ? (
                <Link
                  href={`/courses/aibi-l/${prevSession.number}`}
                  className="flex items-center gap-2 font-mono text-[9px] uppercase tracking-[0.15em] text-[color:var(--ink-2)] hover:opacity-70 transition-opacity focus:outline-none focus:ring-2 focus:ring-[color:var(--ink-2)] focus:ring-offset-2 rounded-sm"
                >
