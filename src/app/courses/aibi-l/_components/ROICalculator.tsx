    ...
    <div>
      ...
      <div className="flex items-center gap-1">
        ...
        <input
          ...
          max={max}
          step={step}
          className="w-full font-mono text-sm tabular-nums text-[color:var(--color-ink)] bg-white border border-[color:var(--color-ink)]/10 px-3 py-2 rounded-[2px] focus:outline-none focus:ring-2 focus:ring-[color:var(--ink-2)] focus:ring-offset-1"
        />
        {suffix && (
          <span className="font-mono text-sm text-[color:var(--color-ink)]/50">
            {suffix}
      ...
      {values.map((val, i) => {
        ...
        return (
          <div key={labels[i]} className="flex-1 flex flex-col items-center gap-2">
            ...
            <div
              className="w-full bg-[color:var(--ink-2)] rounded-[2px] transition-all duration-300"
...
export function ROICalculator() {
  ...
  return (
    <section
      className="bg-[color:var(--color-parch)] border border-[color:var(--ink-2)]/15 rounded-sm"
      aria-labelledby="roi-calculator-heading"
    >
      {/* Header */}
      <div className="px-6 sm:px-10 pt-8 sm:pt-10 pb-6">
        <div className="flex items-center gap-2 mb-4">
          <span className="font-mono text-[9px] uppercase tracking-[0.3em] text-[color:var(--ink-2)]">
            Interactive Worksheet
          </span>
          <div
            className="h-px flex-1 bg-[color:var(--ink-2)]/15"
            aria-hidden="true"
          />
        </div>
        <h2
      ...
      <div className="px-6 sm:px-10 pb-8 sm:pb-10 space-y-10">
        ...
        <div>
          ...
          <div className="hidden sm:block overflow-x-auto">
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-[color:var(--ink-2)]/15">
              ...
              <tbody>
                {departments.map((dept, i) => (
                  <tr
                    key={dept.name}
                    className="border-b border-[color:var(--ink-2)]/8"
                  >
                    ...
                    <td className="py-3 px-2">
                      <input
                        ...
                        className="w-20 font-mono text-sm tabular-nums text-[color:var(--color-ink)] bg-white border border-[color:var(--color-ink)]/10 px-2 py-1.5 rounded-[2px] focus:outline-none focus:ring-2 focus:ring-[color:var(--ink-2)] focus:ring-offset-1"
                    ...
                    <td className="py-3 px-2">
                      <div className="flex items-center gap-1">
                        ...
                        <input
                          ...
                          className="w-28 font-mono text-sm tabular-nums text-[color:var(--color-ink)] bg-white border border-[color:var(--color-ink)]/10 px-2 py-1.5 rounded-[2px] focus:outline-none focus:ring-2 focus:ring-[color:var(--ink-2)] focus:ring-offset-1"
                    ...
                    <td className="py-3 pl-2">
                      <input
                        ...
                        className="w-16 font-mono text-sm tabular-nums text-[color:var(--color-ink)] bg-white border border-[color:var(--color-ink)]/10 px-2 py-1.5 rounded-[2px] focus:outline-none focus:ring-2 focus:ring-[color:var(--ink-2)] focus:ring-offset-1"
          ...
          <div className="sm:hidden space-y-4">
            {departments.map((dept, i) => (
              <div
                key={dept.name}
                className="border border-[color:var(--ink-2)]/10 bg-white p-4 rounded-[2px]"
              >
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full font-mono text-sm tabular-nums text-[color:var(--color-ink)] bg-white border border-[color:var(--color-ink)]/10 px-2 py-1.5 rounded-[2px] focus:outline-none focus:ring-2 focus:ring-[color:var(--ink-2)] focus:ring-offset-1"
                      aria-label={`${dept.name} FTEs`}
                    />
                  </div>
                  <div>
              ...
              <label
                ...
                className={`flex items-center gap-2 px-4 py-2.5 border rounded-[2px] cursor-pointer transition-colors ${
                  scenario === key
                    ...
                    : 'border-[color:var(--color-ink)]/10 bg-white hover:border-[color:var(--ink-2)]/40'
                }`}
              >
                <input
                  type="radio"
        ...
        {/* Section 5: Results */}
        {/* ----------------------------------------------------------------- */}
        <div className="border-t border-[color:var(--ink-2)]/15 pt-8 space-y-8">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                ...
                <tbody>
                  ...
                  <tr className="border-t-2 border-[color:var(--ink-2)]/30">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="border border-[color:var(--ink-2)]/15 bg-white p-5 rounded-[2px]">
              <p className="font-mono text-[9px] uppercase tracking-[0.3em] text-[color:var(--color-ink)]/60 mb-2">
                3-Year Cumulative Savings
              </p>
              <p className="font-mono text-4xl tabular-nums text-[color:var(--ink-2)] leading-none">
          ...
          {/* Methodology note */}
          <div className="border-t border-[color:var(--ink-2)]/10 pt-4">
