...
function DimensionRow({
  ...
  return (
    <div className="py-6 border-b border-[color:var(--ink-2)]/10 last:border-b-0">
      <div className="mb-1">
          ...
          return (
            <button
              ...
              className={`
                ...
                focus:outline-none focus:ring-2 focus:ring-[color:var(--ink-2)] focus:ring-offset-2
                ${
                  isSelected
                    ? 'bg-[color:var(--ink-2)] border-[color:var(--ink-2)] text-[color:var(--color-linen)]'
                    : 'bg-[color:var(--color-linen)] border-[color:var(--ink-2)]/20 text-[color:var(--color-ink)] hover:border-[color:var(--ink-2)]/50'
                }
              `}
            >
...
function DimensionBar({
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      <div className="flex-1 h-2 bg-[color:var(--ink-2)]/10 rounded-sm overflow-hidden">
        <div
          className="h-full bg-[color:var(--ink-2)] transition-all duration-300 rounded-sm"
...
export default function MaturityScorecard() {
  ...
  return (
    ...
    >
      ...
      {allScored && maturity && (
        <div className="px-8 pb-8 pt-6 sm:px-10 sm:pb-10 mt-4 border-t border-[color:var(--ink-2)]/10">
          <div className="flex items-baseline gap-3 mb-6">
            <span className="font-mono text-4xl tabular-nums text-[color:var(--ink-2)]">
              {total}
            </span>
              ...
              className={`
                ...
                ${
                  maturity.level === 'Advanced' || maturity.level === 'Developing'
                    ? `text-[color:var(--ink-2)] border-[color:var(--ink-2)]/30 ${
          ...
          {/* Interpretation */}
          <p className="font-serif italic text-sm text-[color:var(--color-slate)] leading-relaxed border-t border-[color:var(--ink-2)]/10 pt-4">
