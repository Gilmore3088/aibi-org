// /courses/foundations/purchase — Enrollment landing page
...
import { aibiPCourseConfig } from '@content/courses/foundations';

export const metadata: Metadata = {
  title: 'Enroll in AiBI Foundations | The AI Banking Institute',
  description:
    'Enroll in the Banking AI Foundations course. Twelve modules, practical artifacts, and the AiBI Foundations credential upon completion.',
};
    ...
    return (
      <div className="mx-auto max-w-3xl px-8 lg:px-16 py-16">
        ...
        <h1 className="font-serif text-3xl md:text-4xl font-bold leading-tight text-[color:var(--color-ink)] mb-4">
          You&rsquo;re in the AiBI Foundations program.
        </h1>
  ...
  return (
    <div className="mx-auto px-8 lg:px-16 py-8">
      <nav aria-label="Breadcrumb" className="mb-6">
        ...
        <Link href="/courses/foundations" className="font-serif-sc text-[11px] uppercase tracking-[0.18em] text-[color:var(--color-terra)] hover:opacity-80 transition-opacity">
          AiBI Foundations
        </Link>
        <span className="mx-2 text-[color:var(--color-ink)]/20">/</span>
      ...
      <section aria-labelledby="includes-heading" className="mb-10 grid lg:grid-cols-[0.8fr_1.2fr] gap-6 border border-[color:var(--color-ink)]/10 rounded-[3px] p-6">
        ...
        <p className="text-sm text-[color:var(--color-slate)] leading-relaxed">
          ...
          enrolls learners in AiBI Foundations.
        </p>
      </section>
