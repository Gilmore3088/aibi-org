// Dynamic module page — /courses/foundations/[module]
...
import type { Activity, ExpandedModule } from '@content/courses/foundations';
...
import { SANDBOX_CONFIGS } from '@content/sandbox-data/foundations';
import { AIBI_P_ARTIFACTS } from '@content/practice-reps/foundations';
import {
  getModuleActivitySpec,
  buildModuleActivity,
} from '@content/courses/foundations/module-activities';
...
export default async function ModulePage({ params }: ModulePageParams) {
  ...
  if (!canAccessModule(moduleNum, enrollment.completed_modules)) {
    redirect(`/courses/foundations/${enrollment.current_module}`);
  }
