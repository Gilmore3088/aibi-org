// /courses/foundations/tool-guides — Platform deep-dive guides page
...
import {
  ...
  perplexityGuide,
  ALL_TOOL_GUIDES,
} from '@content/courses/foundations/tool-guides-notebooklm-perplexity';

export const metadata: Metadata = {
  title: 'Platform Deep Dive Guides | AiBI Foundations | The AI Banking Institute',
  description:
