// Unit tests for courseProgress.ts — runnable via: npx tsx src/app/courses/foundations/_lib/courseProgress.test.ts
...
import type { Module, Pillar } from '@content/courses/foundations';
