...
/**
 * Look up the current user's AiBI Foundations enrollment from Supabase.
 *
 ...
 * redirect to /courses/foundations/purchase accordingly.
 *
...
export async function getEnrollmentResult(): Promise<EnrollmentResult> {
  ...
  // UI consumer that builds a /courses/foundations/{N} URL needs N >= 1. Coercing
