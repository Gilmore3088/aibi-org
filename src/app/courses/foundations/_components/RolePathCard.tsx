...
import type { RolePath } from '@content/courses/foundations/role-paths';
import { PLATFORM_META } from '@content/courses/foundations';
      ...
      >
        ...
        <div className="p-8 flex flex-col gap-8">
          ...
          <div>
            ...
            <Link
              href={`/courses/foundations/${rolePath.startHereModule}`}
