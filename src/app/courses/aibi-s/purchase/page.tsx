...
// Server Component: checks existing enrollment + AiBI-P prerequisite + user auth
// AiBI-S: $1,495 per seat · Prerequisite: AiBI-P credential · Role track selection
...
export const metadata: Metadata = {
  ...
  description:
    'Enroll in the Banking AI Specialist course. Six weeks, live cohort, for department managers at community banks and credit unions. Prerequisite: AiBI-P certification.',
};
...
async function getUserData(): Promise<{ email: string | null; hasAiBIP: boolean }> {
  ...
  try {
    ...
    // Check AiBI-P enrollment with approved credential
    ...
    // AiBI-P enrollment exists — this is the prerequisite check
      ...
      {userEmail && !hasAiBIP && (
        ...
        >
          ...
          <p className="font-sans text-sm text-[color:var(--color-slate)] leading-relaxed mb-4">
            AiBI-S requires completion of the AiBI-P (Banking AI Practitioner) course. You must earn
            your AiBI-P credential before enrolling in AiBI-S.
          </p>
          <Link
