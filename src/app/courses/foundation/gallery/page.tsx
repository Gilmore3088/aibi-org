// /courses/foundation/gallery — anonymized learner-artifact gallery.
//
// Draft 2026-05-28 (#338). Eight synthetic examples sized one-screen
// each, framed by module number + role. No real customer data; every
// detail is invented but representative of what a learner would
// actually produce.
//
// User should edit the synthetic-but-realistic copy where it doesn't
// match real artifact templates yet. The gallery is a marketing surface
// — it doesn't render dynamic data, just static examples.
