...
// Monospace copy-paste card with a tri-state copy button
// (idle / copied / failed). Falls back to execCommand when
// the async Clipboard API is unavailable.

import { useCallback, useState } from 'react';
import { COPY_RESET_MS, MONO_STACK } from './toolGuideTokens';
    ...
    <div style={{ position: 'relative' }}>
      ...
      <button
        ...
        style={{
          ...
          border: 'none',
          cursor: 'pointer',
          background: failed ? '#B91C1C' : copied ? 'var(--emerald-700)' : 'var(--ink)',
          color: '#FFFFFF',
        }}
        aria-live="polite"
        aria-label={
