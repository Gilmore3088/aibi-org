...
// Gate: all course modules must be completed (enforced client-side and server-side).
...
// Dev bypass: all modules treated as complete; pre-score loaded from localStorage.
...
const REQUIRED_MODULES = foundationCourseConfig.modules.length;
