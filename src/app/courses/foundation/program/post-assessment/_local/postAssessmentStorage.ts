// sessionStorage helpers + per-session constants for the post-course
// assessment. Uses its own STORAGE_KEY so it never collides with the
// public readiness assessment, and migrates from the legacy key.
...
export const LEGACY_STORAGE_KEY = 'aibi-post-assessment-v2';

// Modules 4 (Acceptable Use), 7 (AI Skill), 9 (Capstone)
export const SKILLS_BUILT = 3;
