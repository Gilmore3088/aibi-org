// Module header — dark-band + white-body card (matches /program home's
// ThisWeeksModule pattern; ports course.html .curric).

import { PillarTag } from '@/components/lms';
import type { LMSPillar, ModuleStatus } from '@/components/lms';
import { MOCKUP_FONT, KICKER_STYLE, META_STYLE } from './moduleStyles';
        ...
        >
          <span
            ...
            style={{
              ...
              borderRadius: '50%',
              background:
                status === 'current' || status === 'completed' ? 'var(--gold)' : 'transparent',
