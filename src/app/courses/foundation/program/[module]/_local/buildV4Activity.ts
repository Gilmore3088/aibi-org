// Coerces a V4 ExpandedModule into the legacy Activity shape so that
// modules described only in the V4 content schema still render via the
// existing ModuleContentClient.
