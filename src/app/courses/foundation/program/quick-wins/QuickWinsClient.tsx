...
import { WinsList } from './_components/WinsList';
import { WinsForm } from './_components/WinsForm';
import { WinsLetterCTA } from './_components/WinsLetterCTA';
import { WinsSummaryStrip } from './_components/WinsSummaryStrip';
...
export function QuickWinsClient() {
  ...
  return (
    <div className="mx-auto px-8 lg:px-16 py-16">
      ...
      <WinsList wins={wins} loading={loading} />
