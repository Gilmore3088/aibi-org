    ...
    <main>
      ...
      <section className="px-6 pt-14 pb-10 md:pt-20 md:pb-14">
        <div className="max-w-4xl mx-auto">
          <p className="font-serif-sc text-xs uppercase tracking-[0.2em] text-[color:var(--ledger-ink)]/60 mb-4">
            <Link
          ...
          <h1 className="font-serif text-4xl md:text-5xl text-[color:var(--ledger-ink)] leading-tight mb-6">
            Coaching for institutions in the program.
          </h1>
          <p className="text-lg text-[color:var(--ledger-ink)]/75 max-w-2xl leading-relaxed">
      ...
      <section
        ...
        className="px-6 py-14 md:py-20 border-t border-[color:var(--ledger-ink)]/10 bg-[color:var(--ledger-paper)]"
      >
        <div className="max-w-5xl mx-auto">
          <div className="mb-10 max-w-2xl">
            <p className="font-serif-sc text-xs uppercase tracking-[0.2em] text-[color:var(--ledger-accent)] mb-3">
              Advisory shapes
            </p>
            <h2
              id="advisory-tiers-heading"
              className="font-serif text-3xl md:text-4xl text-[color:var(--ledger-ink)] leading-tight"
            >
          ...
          <div className="space-y-6">
            {advisoryTiers.map((tier) => (
              <article
                key={tier.id}
                className="rounded-[3px] border border-[color:var(--ledger-ink)]/10 overflow-hidden bg-[color:var(--ledger-bg)]"
              >
                <div className="flex">
                  <div
                  ...
                  <div className="flex-1 p-6 md:p-8">
                    ...
                    <h3 className="font-serif text-2xl md:text-3xl text-[color:var(--ledger-ink)] leading-tight mb-2">
                      {tier.name}
                    </h3>
                    <p className="font-serif italic text-sm text-[color:var(--ledger-muted)] leading-relaxed mb-4">
                      {tier.tagline}
                    </p>
                    <p className="text-sm text-[color:var(--ledger-ink)]/75 leading-relaxed mb-5 max-w-2xl">
                      {tier.summary}
                    </p>

                    <dl className="grid sm:grid-cols-3 gap-x-6 gap-y-3 mb-2">
                      <div>
                        <dt className="font-mono text-[9px] uppercase tracking-[0.15em] text-[color:var(--ledger-ink)]/50 mb-1">
                          Best for
                        </dt>
                        <dd className="text-xs text-[color:var(--ledger-ink)]/75 leading-snug">
                          {tier.bestFor}
                        </dd>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <dd className="text-xs text-[color:var(--ledger-ink)]/75 leading-snug tabular-nums">
                          {tier.duration}
                        </dd>
                      </div>
                    </dl>
          ...
          <p className="font-mono text-[10px] uppercase tracking-[0.15em] text-[color:var(--ledger-ink)]/50 mt-8">
      ...
      <section
        ...
        className="px-6 py-14 md:py-20 border-t border-[color:var(--ledger-ink)]/10"
      >
        <div className="max-w-3xl mx-auto">
          <p className="font-serif-sc text-xs uppercase tracking-[0.2em] text-[color:var(--ledger-ink)]/70 mb-3">
            Clarity
          </p>
          <h2
            id="clarity-heading"
            className="font-serif text-3xl md:text-4xl text-[color:var(--ledger-ink)] leading-tight mb-6"
          >
            What we don’t do.
          </h2>
          <ul className="space-y-3">
            {notWhatWeDo.map((line) => (
              <li
                key={line}
                className="text-base text-[color:var(--ledger-ink)]/80 leading-relaxed pl-5 relative"
              >
                <span
                  className="absolute left-0 top-[0.7rem] w-3 h-[1px] bg-[color:var(--ledger-accent)]"
                  aria-hidden="true"
                />
                {line}
              </li>
      ...
      {/* Closing CTA */}
      <section className="px-6 py-14 md:py-20 border-t border-[color:var(--ledger-ink)]/10">
        <div className="max-w-3xl mx-auto bg-[color:var(--ledger-ink)] text-[color:var(--ledger-bg)] p-10 md:p-14 text-center">
          ...
          <p className="text-[color:var(--ledger-bg)]/75 max-w-xl mx-auto mb-6 leading-relaxed">
