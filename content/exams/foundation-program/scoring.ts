...
export const proficiencyLevels: readonly ProficiencyLevel[] = [
  ...
  },
  {
    ...
    recommendation:
      'Review the topic breakdown below. Focus your study on the one or two weakest areas. When your retake places you at Proficient or above, you are ready to submit your work product for the Foundation credential.',
  },
  {
    id: 'proficient',
    label: 'Proficient',
    ...
    recommendation:
      'Proceed to the Foundation certification inquiry form. You will submit a real work product — something you would actually present to a supervisor — assessed across five rubric dimensions (Accuracy, Completeness, Tone, Judgment, Usability).',
  },
  {
    id: 'advanced',
    label: 'Advanced',
    ...
    recommendation:
      'Submit your work product for the Foundation credential and consider whether the Specialist track (AiBI-S) is the right next step for your role. Your topic mastery suggests you may be ready for department-level AI leadership.',
  },
];
