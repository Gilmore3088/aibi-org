...
export const FOUNDATION_MICRO_MODULES: readonly FoundationMicroModule[] = [
  ...
  },
  {
    ...
    title: 'Spot Weak AI Output',
    pillar: 'awareness',
    estimatedMinutes: 10,
    keyOutput: 'Claim Review Markup',
    mission: 'Learn the habit that keeps confident AI language from becoming a banking error.',
    plainLanguageConcept: 'AI often sounds certain before it is correct. Numbers, dates, names, citations, and policy claims need source checks.',
    bankingGuardrail: 'Treat unsupported AI claims as draft language until a source confirms them.',
    guidanceSource: 'NIST AI RMF, CFPB adverse action guidance, NIST GenAI profile',
    tryTask: 'Mark a sample AI answer as verified, unsupported, or wrong.',
    buildTask: 'Build a claim-review markup you can reuse when AI produces facts or policy language.',
    saveArtifact: 'Claim Review Markup',
    visualModel: ['Find claim', 'Find source', 'Mark status', 'Fix output'],
    reviewChecklist: ['Numbers checked', 'Dates checked', 'Policy claims sourced'],
    qualitySignals: ['Evidence attached', 'Unsupported claims flagged', 'No softened guessing'],
    weakExample: 'This sounds regulatory, so it is probably right.',
    strongExample: 'This deadline is unsupported until I confirm it in the source.',
    exampleWhy: 'The strong review treats confidence as a signal to verify, not a reason to trust.',
    transferMove: 'Run this review on one AI-generated paragraph before reusing it.',
    proofToSave: 'Marked output showing verified, unsupported, and corrected claims.',
    reference: commonReference(
      'Confidence is not evidence',
      'Banking outputs that affect customers, controls, reports, or regulated activity need traceable review',
      'Most foundation learners do not need model theory first. They need a practical review reflex: find the claims that can be wrong and attach the evidence before reuse.',
      'Highlight every number, date, name, citation, and policy claim in a sample AI output.',
    ),
  },
  {
    number: 4,
