...
const lendingPath: RolePath = {
  ...
  deepDiveModules: [
    {
      moduleNumber: 8,
      moduleId: 'm8-source-material-safely',
      title: 'Use Source Material Safely',
      focusSection: 'Loan documentation, market data, and credit memo inputs — ground the draft in approved source material before review',
    },
    {
      moduleNumber: 13,
    ...
    {
      moduleNumber: 17,
      moduleId: 'm17-package-reusable-workflow',
      title: 'Create the Reusable Workflow Kit',
      focusSection: 'Package the loan review workflow with inputs, review gates, evidence, and reuse rules',
    },
  ],
...
const operationsPath: RolePath = {
  ...
  deepDiveModules: [
    {
      moduleNumber: 6,
      moduleId: 'm6-structured-output',
      title: 'Ask for Structured Output',
      focusSection: 'Exception reports, meeting notes, and status updates — turn messy inputs into predictable tables and action lists',
    },
    {
      moduleNumber: 13,
      moduleId: 'm13-simple-reusable-skill',
    ...
    },
    {
      ...
      moduleId: 'm17-package-reusable-workflow',
      title: 'Create the Reusable Workflow Kit',
      focusSection: 'Turn the exception report skill into a repeatable workflow with handoffs, evidence, and reuse boundaries',
    },
  ],
  ...
  deepDiveModules: [
    {
      ...
      moduleId: 'm8-source-material-safely',
      title: 'Use Source Material Safely',
      focusSection: 'Regulatory research and policy library work — require source grounding before any compliance recommendation',
    },
    {
      moduleNumber: 12,
      moduleId: 'm12-data-safety-boundaries',
    ...
    {
      moduleNumber: 16,
      moduleId: 'm16-document-evidence-decisions',
      title: 'Keep the Proof',
      focusSection: 'Evidence notes for regulatory work — what was checked, what was escalated, and what source supports the answer',
    },
  ],
  ...
  deepDiveModules: [
    {
      ...
      moduleId: 'm6-structured-output',
      title: 'Ask for Structured Output',
      focusSection: 'Variance tables, board summaries, and financial commentary — ask for output your reviewer can scan and verify',
    },
    {
      moduleNumber: 13,
      moduleId: 'm13-simple-reusable-skill',
    ...
    {
      moduleNumber: 18,
      moduleId: 'm18-foundation-packet-review',
      title: 'Final Foundation Packet Review',
      focusSection: 'Package the finance artifacts, review notes, and reuse boundaries into a manager-ready packet summary',
    },
  ],
...
const marketingPath: RolePath = {
  ...
  deepDiveModules: [
    {
      moduleNumber: 5,
      moduleId: 'm5-add-context-constraints',
      title: 'Add Context and Constraints',
      focusSection: 'Brand voice, channel, audience, and compliance constraints — make the prompt safe before generating campaign copy',
    },
    {
      moduleNumber: 7,
      moduleId: 'm7-review-like-banker',
  ...
  deepDiveModules: [
    {
      ...
      moduleId: 'm12-data-safety-boundaries',
      title: 'Apply Data-Safety Boundaries',
      focusSection: 'Classify IT security, vendor, and policy data before deciding whether an AI tool is allowed to process it',
    },
    {
      moduleNumber: 15,
      moduleId: 'm15-human-review-checkpoints',
      title: 'Set the Human Review Gate',
      focusSection: 'Approval checkpoints for IT governance work — who can block, approve, or escalate before a workflow moves forward',
    },
    {
      moduleNumber: 16,
      moduleId: 'm16-document-evidence-decisions',
      title: 'Keep the Proof',
      focusSection: 'Vendor evaluation evidence and IT governance notes that show what was reviewed and why the decision is defensible',
    },
  ],
...
const retailPath: RolePath = {
  ...
  deepDiveModules: [
    ...
    {
      moduleNumber: 10,
      moduleId: 'm10-role-based-prompt',
...
const executivePath: RolePath = {
  ...
  deepDiveModules: [
    ...
    {
      moduleNumber: 11,
      moduleId: 'm11-choose-ai-use-case',
      title: 'Choose the Right AI Use Case',
      focusSection: 'Separate promising AI use cases from risky automation ideas before assigning staff time or leadership attention',
    },
    {
      moduleNumber: 18,
      moduleId: 'm18-foundation-packet-review',
      title: 'Final Foundation Packet Review',
      focusSection: 'Review the packet as leadership evidence: artifacts, safety boundaries, review notes, and next workflow candidate',
    },
  ],
