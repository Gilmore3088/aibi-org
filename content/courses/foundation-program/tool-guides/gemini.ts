...
export const geminiGuide: ToolGuide = {
  ...
  bankingUseCases: [
    ...
    },
    {
      ...
      prompt:
        'Conduct a comprehensive research review of AI governance requirements and guidance applicable to US community banks and credit unions as of 2026. Cover:\n\n1. Existing federal regulatory frameworks that apply to AI use in banking (SR 26-2 — the April 2026 revised model risk guidance superseding SR 11-7, TPRM guidance, ECOA/Reg B as applied to AI-driven credit decisions, UDAP/UDAAP)\n2. The GAO-25-107197 findings on AI regulation gaps in financial services\n3. The AIEOG AI Lexicon (US Treasury / FBIIC / FSSCC, February 2026) — key defined terms\n4. What FFIEC examination guidance currently says about AI risk management\n5. Any proposed federal legislation or pending rulemaking specifically targeting AI in banking as of 2026\n6. How community banks differ from large bank AI governance requirements\n\nOutput format: executive briefing with source citations for every factual claim.',
      expectedOutput:
