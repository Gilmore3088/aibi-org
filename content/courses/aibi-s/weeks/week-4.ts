...
**Conservative presentation:** Annual projections are projections, not guarantees. The executive summary should label them as projections and note the assumptions (weekly frequency, annual working weeks, hourly rate source). A conservative, sourced projection is more credible than an unsourced optimistic one.`,
    },
    {
      ...
      content: `In AiBI Foundations, the Litmus Test was personal: "If you find yourself having to iterate and refine the output after the skill runs, then the skill itself needs improvement." At department scale, the test adds a second dimension: "Would a new team member produce the same quality output?"
...
The Litmus Test connects directly to Assessment Rubric Dimension 2 (Skill Quality): "Can a colleague who did not build the skill maintain it?" A skill that fails user independence cannot be handed off, and a skill that cannot be handed off is not institutional-grade.`,
    },
    {
      ...
      content: `AiBI Foundations surveyed six platforms. AiBI-S asks a sharper question: which platforms should your department standardize on? Standardization matters because inconsistent platform choices create training overhead, security exposure, and uneven output quality across the team.
