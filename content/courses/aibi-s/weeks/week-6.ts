...
**Dimension 4 — Documentation:** Can someone who did not build this maintain and iterate on it? The test is whether a new team member with AiBI Foundations-level proficiency could use and maintain the skills from the documentation alone — without asking the builder.
    ...
    },
    {
      ...
      rows: [
        ...
        },
        {
          ...
          score3: 'Complete. A new team member with AiBI Foundations proficiency could use and maintain skills from documentation alone.',
