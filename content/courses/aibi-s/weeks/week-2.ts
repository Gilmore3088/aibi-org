...
The other purpose of this week is scale. In AiBI-Foundation, learners set up personal Custom Instructions or Projects. In AiBI-S, the same concept scales to the department. A departmental workspace pre-loads institutional context so that any authorized team member gets output calibrated to the institution, not just to the person who configured it.`,
  ...
  learningGoals: [
    ...
    'Understand the difference between personal platform configuration (AiBI-Foundation) and departmental workspace setup (AiBI-S)',
    'Produce a one-page setup guide that enables a colleague with AiBI-Foundation-level proficiency to access and use the workspace',
  ],
  ...
  sections: [
    {
      ...
      content: `In AiBI-Foundation, you set up Custom Instructions in ChatGPT or a Project in Claude. The context was personal: your role, your institution, your preferences. That configuration made the AI useful for you.
...
**Block 3 — Regulatory context:** The applicable regulatory frameworks for this department's work. Operations focuses on BSA/AML and operational risk. Lending focuses on ECOA/Reg B and SR 11-7. Compliance touches all five frameworks. Finance focuses on financial reporting standards. Retail focuses on consumer protection regulations. This block draws on AiBI-Foundation Module 1 knowledge.
  ...
  tables: [
    {
      ...
      caption: 'Personal Setup (AiBI-Foundation) vs. Departmental Setup (AiBI-S)',
      columns: [
        { header: 'Component', key: 'component' },
        { header: 'Personal Setup (AiBI-Foundation)', key: 'personal' },
...
3. A one-page setup guide written for someone with AiBI-Foundation-level proficiency who has never configured a departmental workspace. Cover: how to access the workspace, what it is for, the data handling rules they must follow, and who to contact if something goes wrong.
